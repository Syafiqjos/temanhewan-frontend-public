...
function ReviewFormComponent({ review }: { review: any }) {
	return <form className="border rounded-lg border-orange-600 p-8 mb-4">
			...
			<InputText label="Publikasi" name="review_rating" value={review.is_public == 1 ? 'Review ditampilkan ke public' : 'Review bersifat privasi dan hanya ditunjukkan kepada jasa grooming'} disabled></InputText>
		</form>;
}
