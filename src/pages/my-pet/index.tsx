      ...
      <main>
        <section className='bg-white'>
          <div className='layout grid grid-cols-1 mt-8 w-100'>
			...
			<Link href="/my-pet/new"><a className="fixed right-4 bottom-4 bg-primary-500 text-white rounded-xl w-16 h-16 flex flex-col items-center justify-center font-semibold text-xl">+</a></Link>
		  </div>
        </section>
      </main>
    </>
